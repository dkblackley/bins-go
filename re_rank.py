...
def main(args):
    ...
    query_embeddings, _ = load_queries_embeddings(root+'../datasets/Son/query_192_float32.npy')#, 'queries_768.npy.ids')
    mrrs = []
    # document_embeddings, idmap = load_embeddings(root+'local_collection.npy', root+'my_vectors_768.npy.ids')
    document_embeddings, idmap = load_embeddings(root+'../datasets/Son/my_vectors_192.npy', root+'my_vectors_768.npy.ids')
